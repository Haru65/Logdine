...
export default defineConfig(({ mode }) => {
  ...
  plugins: [
    ...
    VitePWA({
      ...
      injectRegister: 'auto',
      includeAssets: ['logdine-logo.png', 'robots.txt', 'apple-touch-icon.png', 'offline.html'],
      manifest: {
        id: '/',
        name: 'LogDine Cafe- Smart Cafe Management System',
        short_name: 'LogDine',
        description: 'QR ordering, billing, kitchen, and café management in one dashboard',
        theme_color: '#00dda8',
